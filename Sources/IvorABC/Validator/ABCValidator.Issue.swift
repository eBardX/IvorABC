...
extension ABCValidator {
    ...
    public enum Issue {
        ...
        /// A note or chord has more than one chord symbol attached to it.
        case multipleChordSymbols(Int)

        /// A note or chord has more than one grace note group attached to it.
        case multipleGraceNotes(Int)
...
extension ABCValidator.Issue {
    ...
    public var message: String {
        ...
        case let .multipleChordSymbols(tuneIndex):
            "Tune \(tuneIndex) has a note or chord with more than one chord symbol attached"

        case let .multipleGraceNotes(tuneIndex):
            "Tune \(tuneIndex) has a note or chord with more than one grace note group attached"
    ...
    public var tuneIndex: Int? {
        ...
        case let .invalidInlineField(_, tuneIndex),
             ...
             let .multipleChordSymbols(tuneIndex),
             let .multipleGraceNotes(tuneIndex):
            tuneIndex
