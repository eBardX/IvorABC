...
internal func preprocess(_ data: Data) throws(ABCParser.Error) -> PreprocessResult {
...
private struct PreScanResult {
    ...
    fileprivate var charsetName: String?
    fileprivate var directiveRawVersionString: String?
    fileprivate var directiveVersion: ABCVersion?
    fileprivate var duplicateCharsetNames: [String]
    fileprivate var fileIDRawVersionString: String?
    fileprivate var fileIDVersion: ABCVersion?
}
...
private func _preScanLines(_ lines: [Substring]) -> PreScanResult {
