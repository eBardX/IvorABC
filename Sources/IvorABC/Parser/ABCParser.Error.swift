...
extension ABCParser {
    ...
    public enum Error {
        ...
        /// The underlying tokenizer or token matcher failed while breaking a
        /// music code line into symbols.
        ///
        /// The associated `String` is the description of the wrapped
        /// tokenization/matching error.
