...
///
/// See §4.8 (“Repeat/bar symbols”) of the ABC 2.1 standard.
public struct ABCBarLine {
    ...
    public let followingPlayCount: PlayCount

    /// A Boolean value indicating whether this bar line is dotted.
    ///
    ...
    /// `::|` = `3`). Only meaningful when ``kind`` is `.repeat`.
    public let precedingPlayCount: PlayCount
}
