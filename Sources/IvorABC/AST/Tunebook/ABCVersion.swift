...
///
/// See §2.1 (“ABC file identification”) of the ABC 2.1 standard.
...
extension ABCVersion: Comparable {
    ...
    /// Returns a Boolean value indicating whether this version orders before
    /// another.
    ///
    /// One version orders before another when its major version number is
    /// lower, or when major numbers are equal and its minor version number is
    /// lower.
