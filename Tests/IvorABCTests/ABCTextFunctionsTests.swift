...
extension ABCTextFunctionsTests {
    ...
    // MARK: Backslash — TeX-style two-character escapes
    ...
    // MARK: Backslash — single-character escapes
    ...
    // MARK: Backslash — \uXXXX Unicode codepoints
    ...
    // MARK: In-context: multiple escapes in one string
    ...
    // MARK: Integration: parseField decodes escapes
