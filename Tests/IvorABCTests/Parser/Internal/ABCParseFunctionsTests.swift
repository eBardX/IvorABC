...
extension ABCParseFunctionsTests {
    ...
    func parseNote_success() {
        ...
        #expect(parseNote("a") == ((.a, .omitted, 5), nil, false))
        #expect(parseNote("A,,3") == ((.a, .omitted, 2), makeDuration(3, 1), false))
        #expect(parseNote("A/") == ((.a, .omitted, 4), makeDuration(1, 2), false))
        #expect(parseNote("a2") == ((.a, .omitted, 5), makeDuration(2, 1), false))
        #expect(parseNote("a4") == ((.a, .omitted, 5), makeDuration(4, 1), false))
        #expect(parseNote("b") == ((.b, .omitted, 5), nil, false))
        #expect(parseNote("B/") == ((.b, .omitted, 4), makeDuration(1, 2), false))
        #expect(parseNote("B2") == ((.b, .omitted, 4), makeDuration(2, 1), false))
        #expect(parseNote("B4") == ((.b, .omitted, 4), makeDuration(4, 1), false))
        #expect(parseNote("c") == ((.c, .omitted, 5), nil, false))
        #expect(parseNote("c/") == ((.c, .omitted, 5), makeDuration(1, 2), false))
        #expect(parseNote("c2") == ((.c, .omitted, 5), makeDuration(2, 1), false))
        #expect(parseNote("c3") == ((.c, .omitted, 5), makeDuration(3, 1), false))
        #expect(parseNote("d") == ((.d, .omitted, 5), nil, false))
        #expect(parseNote("d/") == ((.d, .omitted, 5), makeDuration(1, 2), false))
        #expect(parseNote("D//") == ((.d, .omitted, 4), makeDuration(1, 4), false))
        #expect(parseNote("d2") == ((.d, .omitted, 5), makeDuration(2, 1), false))
        #expect(parseNote("e-") == ((.e, .omitted, 5), nil, true))
        #expect(parseNote("e'/") == ((.e, .omitted, 6), makeDuration(1, 2), false))
        #expect(parseNote("e2") == ((.e, .omitted, 5), makeDuration(2, 1), false))
        #expect(parseNote("e3") == ((.e, .omitted, 5), makeDuration(3, 1), false))
        #expect(parseNote("f''''-") == ((.f, .omitted, 9), nil, true))
        #expect(parseNote("f/") == ((.f, .omitted, 5), makeDuration(1, 2), false))
        #expect(parseNote("f2") == ((.f, .omitted, 5), makeDuration(2, 1), false))
        #expect(parseNote("F3/2") == ((.f, .omitted, 4), makeDuration(3, 2), false))
        #expect(parseNote("F8") == ((.f, .omitted, 4), makeDuration(8, 1), false))
        #expect(parseNote("g") == ((.g, .omitted, 5), nil, false))
        #expect(parseNote("G,/2") == ((.g, .omitted, 3), makeDuration(1, 2), false))
        #expect(parseNote("g'2") == ((.g, .omitted, 6), makeDuration(2, 1), false))
        #expect(parseNote("g/") == ((.g, .omitted, 5), makeDuration(1, 2), false))
    }
