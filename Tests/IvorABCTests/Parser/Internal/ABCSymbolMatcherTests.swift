...
extension ABCSymbolMatcherTests {
    ...
    func matchSymbols_beamBreak_spaceSeparated_producesBeamBreakSymbol() throws {
        ...
        #expect(symbols == [.note(ABCNote(pitch: makePitch(.c, .omitted, 4),
                                          duration: makeDuration(1, 8),
                                          isTied: false)),
                            .beamBreak,
                            .note(ABCNote(pitch: makePitch(.d, .omitted, 4),
                                          duration: makeDuration(1, 8),
                                          isTied: false))])
    }
    ...
    func matchSymbols_chord() throws {
        ...
        let notes: [ABCNote] = [ABCNote(pitch: makePitch(.c, .omitted, 4),
                                        duration: makeDuration(1, 8),
                                        isTied: false),
                                ABCNote(pitch: makePitch(.e, .omitted, 4),
                                        duration: makeDuration(1, 8),
                                        isTied: false)]
    ...
    func matchSymbols_graceNotes() throws {
        ...
        let expected: [ABCSymbol] = [.graceNotes(makeGraceNotes([ABCNote(pitch: makePitch(.c, .omitted, 4),
                                                                         duration: makeDuration(1, 8),
                                                                         isTied: false)],
                                                                false))]
    ...
    func matchSymbols_macroCall_static() throws {
        ...
        let graceA = ABCNote(pitch: makePitch(.a, .omitted, 4), duration: makeDuration(1, 8), isTied: false)
        let graceF = ABCNote(pitch: makePitch(.f, .omitted, 4), duration: makeDuration(1, 8), isTied: false)
        let noteG  = ABCNote(pitch: makePitch(.g, .omitted, 4), duration: makeDuration(1, 8), isTied: false)
    ...
    func matchSymbols_macroCall_transposing() throws {
        ...
        let expansion: [ABCSymbol] = [.decoration(makeDecoration("trill", nil, .bang)),
                                      .note(ABCNote(pitch: makePitch(.g, .omitted, 4),
                                                    duration: makeDuration(1, 8),
                                                    isTied: false))]
    ...
    func matchSymbols_note_uppercase() throws {
        ...
        let expected: [ABCSymbol] = [.note(ABCNote(pitch: makePitch(.c, .omitted, 4),
                                                   duration: makeDuration(1, 8),
                                                   isTied: false))]
